...
solder the rest of the pizero onto the board
...
If done correctly, it will show up as a drive on your computer. If this does not happen, hold the BOOT button and press the RESET button one time.
![Screenshot 2025-05-07 19-09-08](https://github.com/user-attachments/assets/a632cb60-43d0-4080-942b-c036f9c10f16)

Drag over the GP2040-CE_0.7.11_WaveshareZero.uf2 firmware linked here
![Screenshot 2025-05-07 19-38-28](https://github.com/user-attachments/assets/44e7905f-b5d7-4695-ab37-40e06e13e0b4)


Allow the device to completely reboot. To test if this worked, head over to [gamepadteste](https://hardwaretester.com/gamepad) and press some buttons
![Screenshot 2025-05-07 19-12-37](https://github.com/user-attachments/assets/15ea31e5-c13b-440c-b678-741d9530a0d3)

Now, hold the SW5 button (bottom right tact switch) and press the RESET button one time.
![Screenshot 2025-05-07 19-39-52](https://github.com/user-attachments/assets/61e69281-5e69-42cf-aaaa-450de9b8a4b5)


Next, head to http://192.168.7.1 in a web browser
